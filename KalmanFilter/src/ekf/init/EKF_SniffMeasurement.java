...
public class EKF_SniffMeasurement implements  IEKFinit{
	...
	private double[] yPositionArray  = new double[EKFConstant.sniffMeasNumForInitStateVector];
	private double[] zPositionArray  = new double[EKFConstant.sniffMeasNumForInitStateVector];
